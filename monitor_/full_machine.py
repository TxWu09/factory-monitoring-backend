            ...
            for video_stream in self.video_streams:
                ...
                if message is not None:
                    ...
                    if video_type == 1:
                        print(video_type)
                        print(stream_name)
                        print(self.minio.check_image_exists(self.minio_config['bucket_name1'], stream_name))
                        if not self.minio.check_image_exists(self.minio_config['bucket_name1'], stream_name):
                            self.minio.put_image(self.minio_config['bucket_name1'], stream_name, jpeg_data, video_info['capture_time'])
                        ...
                        print(video_type)
                        print(stream_name)
                        print(self.minio.check_image_exists(self.minio_config['bucket_name2'], stream_name))
